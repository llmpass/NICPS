...
// Constructor
//********************************************
CVector3d::CVector3d(CVector3d &vector1)
{
	Set(&vector1);
}
...
// Copy
//********************************************
void CVector3d::Copy(CVector3d &vector1)
{
	Set(&vector1);
}
...
// Set
//********************************************
void CVector3d::Set(CVector3d &vector1)
{
	Set(vector1.x(),vector1.y(),vector1.z());
}
...
// Operator = 
//********************************************
CVector3d CVector3d::operator=(CVector3d& vector1)
{
	CVector3d v;
	v.Set(vector1);
	return v;
...
{
	double x = (double)m_y*(double)v.z()-(double)m_z*(double)v.y();
	double y = (double)m_z*(double)v.x()-(double)m_x*(double)v.z();
	double z = (double)m_x*(double)v.y()-(double)m_y*(double)v.x();
